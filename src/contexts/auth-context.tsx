...
interface AuthContextType {
  ...
  loadingAuth: boolean;
  signUpUser: (email: string, password: string, firstName: string, lastName: string) => Promise<AppUser | null>;
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const signUpUser = async (email: string, password: string, firstName: string, lastName: string): Promise<AppUser | null> => {
    try {
  ...
  return (
    <AuthContext.Provider value={{
      ...
      signOutUser,
      updateUserProfile,
      saveUserProfile: updateUserProfile, // Alias for backward compatibility if any
      sendPasswordReset,
    }}>
      {children}

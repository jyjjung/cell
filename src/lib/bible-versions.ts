...
const BIBLE_VERSION_STORAGE_KEY = 'bibleTextVersion';

const BIBLE_VERSION_LABELS: Record<BibleTextVersion, string> = {
  krv: 'KRV',
  esv: 'ESV',
};

const DEFAULT_BIBLE_TEXT_VERSION: BibleTextVersion = 'krv';

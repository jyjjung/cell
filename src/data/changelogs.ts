...
export const changelogs: ChangelogEntry[] = [
  ...
  },
  {
    ...
    changes: [
      {
        type: 'Added',
        text: 'Public setlist links now open for guests without requiring a member login.',
      },
    ],
  },
  {
    ...
    changes: [
      {
        type: 'Fixed',
        text: 'Chord sheets now keep song titles, credits, and closely placed chord changes readable.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    changes: [
      {
        type: 'Added',
        text: 'Admins can copy secure public links for files and folders, so guests can view shared resources without member role access.',
      },
      {
        type: 'Fixed',
        text: 'PDF previews now use a bundled worker for more reliable loading.',
      },
    ],
  },
  {
    version: 'v1.20.11',
    subtitle: 'Role-based file access',
    date: 'September 24, 2026',
    changes: [
      {
        type: 'Added',
        text: 'Admins can limit shared files and folders to selected roles, while approved members keep access to public resources.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    changes: [
      {
        type: 'Fixed',
        text: 'File names now open their previews directly, with a single clear close control.',
      },
      {
        type: 'Fixed',
        text: 'Signed-out visitors are sent to sign in for member-only pages while public forms remain available.',
      },
      {
        type: 'Fixed',
        text: 'Shared PDFs and other browser-renderable resources now open correctly in the in-app viewer.',
      },
    ],
  },
  {
    version: 'v1.20.8',
    subtitle: 'Organized file library',
    date: 'September 24, 2026',
    changes: [
      {
        type: 'Added',
        text: 'Admins can now create folders and rename or remove shared resources, making the file library easier to organize.',
      },
    ],
  },
  {
    version: 'v1.20.7',
    subtitle: 'Shared file library',
    date: 'September 24, 2026',
    changes: [
      {
        type: 'Added',
        text: 'Admins can now upload and manage shared images, PDFs, documents, and other resources in one place.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    changes: [
      {
        type: 'Changed',
        text: 'Birthday chats are kept as shared memories in a visible archive for everyone.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    changes: [
      {
        type: 'Fixed',
        text: 'Birthday people can keep viewing their celebration room and memories after the room closes.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    changes: [
      {
        type: 'Improved',
        text: 'Text-based sheets now open directly with transpose and notes controls ready to use.',
      },
      {
        type: 'Fixed',
        text: 'Compact pasted chord lines now keep every chord with the right lyric, including trailing parenthesized measures.',
      },
      {
        type: 'Improved',

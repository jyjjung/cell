    ...
    <DayPicker
      ...
      classNames={{
        ...
        day_button: cn(
          buttonVariants({ variant: "ghost" }),
          compact
            ? "h-8 w-8 rounded-lg p-0 text-xs font-normal"
            : "h-10 w-10 rounded-lg p-0 font-normal",
        ),
        range_end: "day-range-end",
        selected:
          "rounded-lg bg-primary text-primary-foreground hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground [&>button]:rounded-lg [&>button]:bg-primary [&>button]:text-primary-foreground [&>button:hover]:bg-primary [&>button:hover]:text-primary-foreground [&>button:focus]:bg-primary [&>button:focus]:text-primary-foreground",
        today: "font-semibold",
        outside:

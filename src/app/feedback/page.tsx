...
const changelogs = [
  ...
  },
  {
    ...
    date: "July 29, 2026",
    changes: [
      "Chat and group photo uploads work again for signed-in members",
    ],
  },
  {
    version: "v1.3.142",
  ...
  },
  {
    ...
    date: "July 28, 2026",
    changes: [
      "Push notifications are more reliable: failed deliveries are retried by the morning reminder job, birthday alerts use correct community dates, and community-wide alerts show in the notification list",
  ...
  },
  {
    ...
    date: "July 17, 2026",
    changes: [
      "Tapping the chat message box no longer scrolls the whole page — the top bars stay put and the keyboard stays open",
    ],
  },
  {
    version: "v1.3.111",

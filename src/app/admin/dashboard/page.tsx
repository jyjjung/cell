...
import { PlusCircle, Edit, Trash2, CalendarPlus, ListOrdered, BookHeart } from 'lucide-react';
...
export default function AdminDashboardPage() {
  ...
  const handleAddEvent = async (data: AppEvent) => {
    // Firestore ID is generated by addEvent hook, so we pass data without ID initially
